export const newsArticles = [
  ...
  <ul>
    <li><strong>- Our self-service toolkits:</strong> Empowering project developers with guided workflows for approval pathways, contracting models, and funding options.</li>
    <li><strong>- Innovative capital investment:</strong> Designing, marketing, and transacting across cutting-edge technologies.</li>
  ...
  <strong>1. The right kind of capital</strong><br/>
  <em>How do we ensure that funding aligns with the needs of early-stage innovators and large-scale industries alike?</em>
  
  <p>Public funding for climate technologies surged in 2024, driven by the US Inflation Reduction Act and national efforts to secure sovereign capabilities. While this has sparked investment and de-risking in some sectors, for us it raised the question of whether the right type of capital is funding the transition.</p>
  
  <p>In markets like Australia, heavy investment in de-risked solutions is crowding out private capital for early-stage innovations, while traditional venture funding also appears ill-suited to company growth needs. A focus on capital volume over risk reduction has limited the impact of blended and concessional funding programs to bridge this gap.</p>

  <p>For capital-intensive climate startups, this means it's often not the best technology that wins, but the ones that can leverage partnerships to achieve growth. For policy-makers and investors, there is a clear need to deploy better financing mechanisms that address uncertainty and boost local investor confidence. Insurance and guarantees, for example, remain critically missing, reducing the entry of traditional finance into the sector at earlier stages.</p>
  <br/>
  <strong>2. The future of industrial decarbonization</strong><br/>
  ...
  <br/>
  <strong>3. Asia Pacific’s role</strong>
  <br/>
  <em>How can we leverage this region’s unique position to lead the global energy transition?</em>
  <p>Asia Pacific occupies a pivotal position in the global energy transition. As the world's factory, home to the largest share of global population, and a key source of natural resources, the region is where decarbonization, industrial transformation and capacity development converge. </p>
  <p>Despite its importance, the region has often been overshadowed by the United States’ policy incentives and the European Union’s regulatory frameworks. This underinvestment represents a missed opportunity, but the landscape is rapidly changing. </p>
  <p>A growing pragmatism is shaping decarbonization efforts. Governments and corporations are increasingly collaborating to build local capabilities, enhance efficiencies and secure competitive advantages in the global economy. Investors are responding by channelling more targeted resources into joint ventures and large cross-border projects, fostering an exciting environment for innovation and scalability.</p>
  <p>This evolution underscores the need for mechanisms that bridge high-potential innovations with established industry leaders. By fostering collaboration between startups, innovators, and incumbents, the Asia Pacific can position itself as a powerhouse for deploying and scaling breakthrough technologies, ensuring a decisive contribution to the global energy transition.</p>
  <br/>
  <strong>Looking ahead</strong><br/>
  <em>As we approach 2025, we’ve reflected deeply on our role – where can we make the greatest impact?</em>
  ...
  <strong>Introducing Tegro Commodity Partners</strong>
  <p>Tegro Commodity Partners embodies our commitment to addressing the challenges and opportunities of 2025, leveraging the collective strengths of our team to drive systemic change.</p>
  
  <p>Our name Tegro is built on the values of:</p>
  <ul>
  <li><strong>- Integrity:</strong> Supporting solutions that can be measured and managed effectively for sustained impact.</li>
  <li><strong>- Technology:</strong> A belief in technology innovation to build the large-scale solutions we need.</li>
  <li><strong>- Growth:</strong> Recognising the need for projects to deliver economic growth.</li>
  </ul>
  <br/>
...
<ul>
  <li><strong>- Tegro Carbon Platform:</strong> A tailored operating platform that will solve for risk, volume, and scale issues between carbon credit buyers and project developers.</li>
  <li><strong>- Sustainable Aviation Fuel (SAF) Facility:</strong> A novel funding facility and insurance wrap with the aim to de-risk and catalyze capital into the SAF industry in Southeast Asia alongside industry and blended finance partners.</li>
</ul>
<br/>
